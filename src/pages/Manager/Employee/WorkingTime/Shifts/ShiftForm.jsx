        ...
        >
            <Form form={form} layout="vertical" onFinish={handleSubmit}>
                ...
                <Form.Item
                    ...
                    label="Loại ca"
                    rules={[
                        { required: true, message: "Vui lòng chọn loại ca!" },
                    ]}
                >
                    <Select placeholder="Chọn loại ca">
                        <Select.Option value={SHIFT_TYPE.MORNING}>
                            Ca Sáng
                        </Select.Option>
                        <Select.Option value={SHIFT_TYPE.AFTERNOON}>
                            Ca Chiều
                        </Select.Option>
                        <Select.Option value={SHIFT_TYPE.EVENING}>
                            Ca Tối
                        </Select.Option>
                        <Select.Option value={SHIFT_TYPE.NIGHT}>
                            Ca Đêm
                        </Select.Option>
                    </Select>
                </Form.Item>
                ...
                <Form.Item
                    ...
                    rules={[
                        { required: true, message: "Nhập số giờ làm việc!" },
                    ]}
                >
                    <InputNumber
                        min={1}
