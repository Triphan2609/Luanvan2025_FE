...
export default function Invoice() {
    ...
    const handleDownloadPDF = async () => {
        try {
            ...
            // Sử dụng data.booking.id thay vì booking.id
    ...
    if (!data) {
        return (
            <Result
                ...
                extra={
                    <Button type="primary" onClick={() => navigate("/hotel/payment")} icon={<RollbackOutlined />}>
                        Quay lại
                    </Button>
                }
            />
            ...
            <Card>
                <Space direction="vertical" style={{ width: "100%" }} size="large">
                    <Space style={{ justifyContent: "flex-end", width: "100%" }}>
                        <Button icon={<RollbackOutlined />} onClick={() => navigate("/manager/hotel/payment")}>
                            Quay lại
                        </Button>
                    ...
                    <div ref={invoiceRef}>
                        <InvoiceTemplate booking={data.booking} paymentInfo={data.paymentInfo} />
                    </div>
                </Space>
            </Card>
        </div>
